...
describe("tiny-compose", () => {
  it("should apply the results of function calls to successive funcitons from right to left", () => {
    ...
    const fiftyNine = compose(addFive, double, cube)(3);
  ...
  it("should compose the same function repeatedly", () => {
    const double = spy(n => 2 * n);
    const twentyFour = compose(double, double, double)(3);
